...
//     // debugPrint("✅ Payment Authorized: ${response.paymentId}");
//
...
//     }
//
//     /// 3️⃣ WALLET → SUB WALLET CHECK
//     // String? walletType;
//     String? walletType;
//     if (selectedPaymentMethod == "Maamaas_Wallet") {
//       if (selectedSubWallet.isEmpty) {
//         _showError("⚠️ Please select a sub-wallet");
//         return;
//       }
//
//       walletType = selectedSubWallet; // ✅ DIRECT BACKEND VALUE
//     }
//
...
//   //       content: Row(
//   //         children: [
//   //           Icon(Icons.error_outline, color: Colors.white, size: 22.sp),
//   //           SizedBox(width: 12.w),
//   //           Expanded(
//   //             child: Text(
//   //               message,
...
//   //     );
//   //
//   //     // 🔥 Replace cart screen so it never shows again
//   //     Navigator.pushReplacement(
//   //       context,
//   //       MaterialPageRoute(builder: (_) => food_Invoice(orderId: orderId)),
//   //     );
//   //   } else {
//   //     setState(() => _isPlacingOrder = false);
//   //     final msg = result?['message'] ?? "Failed to place order";
//   //     ScaffoldMessenger.of(
//   //       context,
...
//                     if (isLoading)
//                       _cartSkeletonScreen()
//                     else if (cartData == null || cartData!.cartItems.isEmpty)
//                       _buildEmptyCart(context)
//                     else ...[
//                         _buildCartItems(theme, colorScheme),
...
//                             setState(() {
//                               cartData = updatedCart;
//                               hasUserSelectedOrderType = true; // 🔥 KEY LINE
//                             });
//                           },
//                         ),
//
//                         if (hasUserSelectedOrderType) ...[
//                           SizedBox(height: 12.h),
//                           _buildCouponRow(theme, colorScheme),
//                           SizedBox(height: 10.h),
//
//                           // if ((cartData?.orderType ?? '').trim().toLowerCase() ==
//                           //     'delivery')
...
//   //   final Color accentColor = const Color(0xFFB15DC6);
//   //
//   //   return Container(
...
//       String title,
//       String backendValue, // 👈 IMPORTANT
//       double amount,
//       ThemeData theme,
//       ColorScheme colorScheme,
//       ) {
//     final isSelected = selectedSubWallet == backendValue;
//
//     return InkWell(
//       onTap: () {
//         setState(() {
//           selectedSubWallet = backendValue; // 👈 store backend value
//         });
//       },
//       child: Container(
